...
#
# last number (5000) means learning epochs, default=1000 if omitted
...
#	i_train.append([x * 1.0, y * 1.0])
#	o_train.append(c * 1.0)

i_train.append([0.0, 0.0])
o_train.append(0.0)
i_train.append([0.0, 1.0])
o_train.append(1.0)
i_train.append([1.0, 0.0])
o_train.append(1.0)
i_train.append([1.0, 1.0])
o_train.append(0.0)
...
for ix in range(ticks):
	for iy in range(ticks):
		a.append([ix * 2.0 / ticks - 0.5, iy * 2.0 / ticks - 0.5])
